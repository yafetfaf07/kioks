...
export class ProductRouter {
  ...
  registerRoutes() {
    ...
    this.router.patch("/updateProduct/:id", this._controller.updateProduct.bind(this._controller));
    this.router.get('/getProductByName/:mid/:name',this._controller.getProductByNameAndMerchantId.bind(this._controller));
    return this.router;
  }
}
